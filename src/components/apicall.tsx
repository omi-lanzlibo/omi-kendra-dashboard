    ...
    return (
        <div>
            <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-2 xl:grid-cols-2">
                {responseItems.length > 0 && responseItems[0] && (
                    <Card x-chunk="dashboard-05-chunk-1">
                        <CardHeader className="pb-2">
                            <CardDescription>Date: {displayDate}</CardDescription> {/* Display the date */}
                            <CardTitle className="text-4xl">{responseItems[0].count?.N}</CardTitle>
                        </CardHeader>
                        <CardContent>
